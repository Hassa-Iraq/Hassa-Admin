...
export async function PATCH(request, context) {
  try {
    ...
    const candidateEndpoints = [
      `/api/restaurants/${restaurantId}/unblock`,
      `/api/restaurants/admin/${restaurantId}/unblock`,
    ];
    ...
    throw new Error('Restaurant unblock endpoint not found');
  } catch (error) {
    return getErrorResponse(error, 'Failed to unblock restaurant');
  }
}
