...
//             <div
//               key={person.id}
//               className="bg-[#F8F8FA] rounded-lg shadow-md px-4 py-5 border border-[#7C3AED] flex flex-col items-center cursor-pointer transition hover:shadow-lg"
//             >
//               {/* Avatar */}
//               <div className="relative mb-3">
//                 <img
//                   src={`https://ui-avatars.com/api/?name=${person.avatar}&background=555&color=fff&size=64`}
//                   alt={person.name}
...
//               {/* Name */}
//               <h3 className="text-[14px] font-medium text-gray-800 whitespace-nowrap">
//                 {person.name}
//               </h3>

//               {/* Orders */}
//               <p className="text-[14px] text-teal-500 font-semibold mt-1">
      ...
      <div className="p-6 max-h-[320px] overflow-y-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {deliveryMen.map((person) => (
            <div
              key={person.id}
            //   className="bg-white bg-opacity-70 rounded-lg shadow-md px-5 py-4 border border-[#8A8A9E80] border-opacity-50 flex flex-col items-center cursor-pointer transition hover:shadow-lg"
              // >
