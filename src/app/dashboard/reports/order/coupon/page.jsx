  ...
  return (
    <div className="rounded-md border border-gray-200 bg-white px-3 py-2">
      <div className="flex items-center justify-between text-[11px]">
        ...
        <span className="text-gray-500">$ 12.45k</span>
      </div>
    </div>
  );
}

export default function CouponOrderReportPage() {
  return (
    <div className="space-y-4">
      ...
      <section className="grid grid-cols-1 gap-2 md:grid-cols-3">
        {['In Progress Orders', 'On The Way', 'Cancelled Orders', 'Failed Orders', 'Refunded Orders', 'Delivered Orders'].map((item) => (
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr key={row.id + index} className="border-b border-gray-100 last:border-b-0">
                  ...
                  <td className="px-2 py-2 text-[11px]">$ 370.00</td>
                  ...
                  <td className="px-2 py-2 text-[11px] text-rose-400">Refund Cancelled</td>
                </tr>
              ))}
            </tbody>
          </table>
